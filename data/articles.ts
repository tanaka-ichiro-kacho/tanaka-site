...
export const articleSummaries: ArticleSummary[] = [
  ...
  {
    id: "fan-retro-01-angle",
    issue: "第15号",
    category: "道具のあるある",
    categoryIndex: "道具のあるある・05",
    title: "扇風機の首振り角度は、自分の手で決めないと気が済まないのである",
    excerpt: "リモコンより手で向きを合わせないと気が済まない。",
  },
  {
    id: "icepick-01-block-ice",
    issue: "第16号",
    category: "晩酌のあるある",
    categoryIndex: "晩酌のあるある・03",
...
export const articleDetails: ArticleDetail[] = [
  ...
  },
  {
    ...
    prNotice: "PR ― 本記事は広告(Amazonアソシエイト)を含みます",
    paragraphsBeforeQuote: [
      "我が家の扇風機はリモコン一つで首振りの角度まで細かく設定できる。だが自分はいつも、わざわざ本体に近づいて手で向きを変えてしまう。妻には「リモコンがあるのに何をしているんだ」と呆れられるが、どうにもボタンだけでは物足りない。",
    ],
    quoteLine:
      "角度はボタンで決まるものではなく、手で決めるから納得がいくのだと思っている。",
    paragraphsAfterQuote: [
      "昔の扇風機は手で押して向きを変えるしかなかった。不便には違いないが、その一手間が「よし、今日はこの角度で」という区切りになっていた気がする。今はリモコンで数値まで設定できて便利だが、決めた実感のようなものは薄くなった気がしてならない。",
    ],
    product: {
      tag: "課長の道具箱",
      heading: "リモコン任せにせず、手で向きを合わせられる扇風機を選ぶ",
      description:
        "レトロなデザインの扇風機は、見た目はどこか懐かしいが、首を振る動きはしっかりしていて頼りになる。リモコンに頼らず手で向きを合わせても様になるところが、意外と気に入っている。",
      ctaLabel: "Amazonで確認する",
      ctaHref: "https://link.amazon/B07pkha2X",
    },
    closingParagraphs: [
      "結局、今日も手で角度を合わせてから風にあたっている。家族には面倒なことをしていると笑われるが、この一手間だけは譲れないのである。",
    ],
  },
  {
    id: "icepick-01-block-ice",
    ...
    prNotice: "PR ― 本記事は広告(Amazonアソシエイト)を含みます",
    paragraphsBeforeQuote: [
      "冷蔵庫の自動製氷機を使えば、ボタン一つで氷は出てくる。それでも週末は、あえて大きな塊氷を用意してアイスピックで割ることにしている。家族には「危ないからやめてくれ」と何度も言われているが、この工程だけはやめられない。",
    ],
    quoteLine:
      "氷を割る手が危なっかしいと言われるが、晩酌の格はそこで決まると思っている。",
    paragraphsAfterQuote: [
      "自動製氷機やコンビニの氷は粒が揃っていて便利だが、どれも同じ大きさで、氷そのものに存在感がない。昔は氷屋から塊で買ってきて、自分で割るのが当たり前だった。手間がかかる分、割れた氷の形は毎回違い、グラスの中でどっしりと構える。便利になった分、そういう不揃いさは失われた気がする。",
    ],
    product: {
      tag: "課長の道具箱",
      heading: "手元が滑りにくいアイスピックを、酒棚の近くに常備する",
      description:
        "製氷皿・アイスピックセットのピック部分は、柄がしっかりしていて手元が滑りにくい。危なっかしいと言われる作業も、道具がしっかりしていれば身構えずに取り組める。晩酌前のひと手間として、酒棚の近くに常備している。",
      ctaLabel: "Amazonで確認する",
      ctaHref: "https://link.amazon/B0gGab8pM",
    },
    closingParagraphs: [
